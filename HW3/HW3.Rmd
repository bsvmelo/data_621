...
```{r predictor transformation check}
par(mfrow=c(2,4))
...
plot(roc(train$target,  predict(m6, train, interval = "prediction")), print.auc = TRUE)
```


```{r}
# plotting roc curve of model 5
plot(roc(train$target,  predict(m5, train, interval = "prediction")), print.auc = TRUE)
```


```{r}
# plotting roc curve of model 4
plot(roc(train$target,  predict(m4, train, interval = "prediction")), print.auc = TRUE)
```

It looks like Model 1 or 4 will be the best models.