...
```{r}
Value <- c(accuracy(cm), error_rate (cm), f1_score(cm),precision(cm), sensitivity(cm), specificity(cm))
names(Value) <- c("accuracy", "error_rate", "f1_score", "precision", "sensitivity", "specificity")
